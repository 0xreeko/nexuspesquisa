    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <div className={styles.left}>
          <p className={styles.link}>Sobre</p>
          <p className={styles.link}>Documentação da API</p>
        </div>
        <div className={styles.right}>
          <p className={styles.link}>Nexus Mail</p>
          <p className={styles.link}>Mercado da NFTs</p>
      ...
      <form className={styles.form}>
        <Image src="https://cdn.freebiesupply.com/logos/thumbs/2x/google-nexus-logo.png" width={300} height={100} objectFit="cover" alt='nexus' />
        <div className={styles.main}>
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
        <input ref={searchInputRef} type="text" name="search" id="search" className={styles.inputField} />
        </div>
        <div className={styles.groupedButtons}>
          <button onClick={(e) => search(e)} className={styles.button}>Nexus Pesquisa</button>
